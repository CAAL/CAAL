...
echo ""
echo "  Echolalia: http://127.0.0.1:$PORT/ccs-tool/src/gui/demos/echolalia/"
echo "  HalfViz:   http://127.0.0.1:$PORT/ccs-tool/src/gui/demos/halfviz/"
echo "  Atlas:     http://127.0.0.1:$PORT/ccs-tool/src/gui/demos/atlas/"
echo ""
